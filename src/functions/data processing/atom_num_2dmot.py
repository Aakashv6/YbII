...
def var_extract(dir, keywords=[["exp", 1e-3], ["d0", 1e-3]], save_params=True):
    ...
    if save_params:
        np.savetxt("C:/Users/YbII Cobra/Documents/YbII/results/" + "exp_params.csv", exp_params, delimiter=",", fmt='%s')

# var_extract("C:/Users/YbII Cobra/Documents/YbII/data/")

def fit_data(dir, t_exp, df, p, d0, fit_override=None, param_init=None, constraints=None, plot_save=True, save_data=False):

    exp_params = np.loadtxt("C:/Users/YbII Cobra/Documents/YbII/results/" + "exp_params.csv", dtype=str, delimiter=",")
    ...
    for f in range(exp_params.shape[0]):
        ...
        img_res, x0, y0, wx, wy, bgx, bgy, x_data, x_fit, y_data, y_fit, atom_num = plotMOTNumber(img_data, img_bg, f_data, t_exp, df, p, float(exp_params[f, 2]), fit_override, param_init, constraints, plot_save)
    ...
    exp_params = np.savetxt("C:/Users/YbII Cobra/Documents/YbII/results/" + "exp_params.csv", exp_params, delimiter=",", fmt='%s')

fit_data("C:/Users/YbII Cobra/Documents/YbII/data/", 25e-3, 2 * np.pi * 751.5270397e12, 80e-3, 350e-3)
